<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('fakultas.index')" :active="request()->routeIs('fakultas.index')">
    {{ __('Data Fakultas') }}
</x-nav-link>
                    ...
                    <x-nav-link :href="route('mahasiswa.sks')" :active="request()->routeIs('mahasiswa.sks')">
    {{ __('Daftar Mahasiswa & SKS') }}
</x-nav-link>   
    ...
    <div :class="{ 'block': open, 'hidden': ! open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('matakuliah.index')" :active="request()->routeIs('matakuliah.*')">
                {{ __('Data Mata Kuliah') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('krs.index')" :active="request()->routeIs('krs.*')">
                {{ __('Pengisian KRS') }}
            </x-responsive-nav-link>
        </div>
